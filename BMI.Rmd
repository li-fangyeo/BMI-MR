...
args <- list(
  ...
  optparse::make_option("--detection", type = "numeric", default = 1/100, help = "Detection limit [default %default]"),
optparse::make_option("--prevalence", type = "numeric", default = 25/100, help = "Prevalence limit [default %default]")) %>% 
