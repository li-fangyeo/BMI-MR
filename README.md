...
```
cd existing_repo
git remote add origin https://gitlab.com/turku-hypertension-center/bmi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/turku-hypertension-center/bmi/-/settings/integrations)
